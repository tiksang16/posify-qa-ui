...
test.describe("Promotion ", () => {
  ...
  test("MKT/PROMO/5.2.2.1/9 - 推广规则：买不少于金额2000就可以享受100的固定折扣，去推广优惠下不包括的会员等级使用", async () => {
  
    await marketingPage.activatePromotion("买满2000减100, 去推广优惠下不包括的会员等级使用");
    ...
    await marketingPage.deactivatePromotion("买满2000减100, 去推广优惠下不包括的会员等级使用");
  });
