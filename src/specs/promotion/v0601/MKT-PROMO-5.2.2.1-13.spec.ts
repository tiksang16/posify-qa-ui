...
test.describe("Promotion ", () => {
  ...
  test("MKT/PROMO/5.2.2.1/13 - 推广规则：买不少于金额2000就可以享受100的固定折扣不启用到online，但在online购物", async () => {
    ...
    await loginPage.page.locator("xpath=//button[@data-category='promotion']").nth(0).click();
    await loginPage.page.waitForTimeout(3000);
    await loginPage.page.locator('xpath=//input[@class="select2-search__field"]').nth(0).click();
