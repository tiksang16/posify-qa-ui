...
test.describe("Promotion ", () => {
  ...
  test("MKT/PROMO/5.2.2.1/2 - 买相等于数量2就可以获得15积分，实际数量买4", async () => {
    await marketingPage.activatePromotion("不少于数量2送15积分");
    ...
    await marketingPage.deactivatePromotion("不少于数量2送15积分");
  });
});
